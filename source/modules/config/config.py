...
class setup_configuration():
    def __init__(self):
        ...
        self.test_datatype = 'AdobeNPI' # Test Data Type (Fix)
        self.test_prefix = '*.tif' # only images with this prefix are loaded
        self.test_suffix = 'data' # only directories with this suffix are loaded (for DiLiGenT)
